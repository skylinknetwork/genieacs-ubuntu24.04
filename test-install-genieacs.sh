...
# MongoDB 7.0 + mongosh dari bundle GitHub
set -euo pipefail
...
# =====================================================
# 3. Install MongoDB 7.0 dari bundle GitHub
# =====================================================
echo "=== [3/6] Install MongoDB 7.0 dari bundle GitHub ==="

MONGO_URL="https://raw.githubusercontent.com/skylinknetwork/genieacs-ubuntu24.04/main/mongodb-org-7.0-bundle.tar.gz"
...
echo "[INFO] Download bundle MongoDB (ini bisa agak lama)..."
